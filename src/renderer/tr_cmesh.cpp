...
// GR - tessellate according to model capabilities
			R_AddDrawSurf( (surfaceBase_t*)surface, tr.shadowShader, 0, qfalse, tr.currentModel->ATI_tess, i, &ent->dxrMesh );
		}
...
//----(SA)	done testing
		...
		if ( !personalModel ) {
// GR - tessellate according to model capabilities
			R_AddDrawSurf( (surfaceBase_t*)surface, shader, fogNum, qfalse, tr.currentModel->ATI_tess, i, &ent->dxrMesh);
		}
