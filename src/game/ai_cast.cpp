...
void AICast_Init( void ) {
	...
	sys->Cvar_Register( &aicast_debug, "aicast_debug", "0", 0 );
	sys->Cvar_Register( &aicast_debugname, "aicast_debugname", "", 0 );
	sys->Cvar_Register( &aicast_scripts, "aicast_scripts", "1", 0 );
	...
	sys->Cvar_Register( &cvar, "aicast_thinktime", "50", 0 );
	aicast_thinktime = sys->Cvar_VariableIntegerValue( "aicast_thinktime" );

	sys->Cvar_Register( &cvar, "aicast_maxthink", "4", 0 );
	aicast_maxthink = sys->Cvar_VariableIntegerValue( "aicast_maxthink" );
