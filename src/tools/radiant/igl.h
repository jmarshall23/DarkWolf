...
// plugins can draw in their own window using Radiant's gl bindings
//
...
//	float m_fVersion;
	int m_nSize;
	PFN_QGLALPHAFUNC		m_pfn_glAlphaFunc;
	PFN_QGLBEGIN			m_pfn_glBegin;
	PFN_QGLBINDTEXTURE		m_pfn_glBindTexture;
	PFN_QGLBLENDFUNC		m_pfn_glBlendFunc;
	PFN_QGLCALLLIST			m_pfn_glCallList;
	PFN_QGLCLEAR			m_pfn_glClear;
	PFN_QGLCLEARCOLOR		m_pfn_glClearColor;
	PFN_QGLCALLLISTS		m_pfn_glCallLists;
	PFN_QGLCLEARDEPTH		m_pfn_glClearDepth;
	PFN_QGLCOLOR3F			m_pfn_glColor3f;
	PFN_QGLCOLOR4F			m_pfn_glColor4f;
	PFN_QGLCULLFACE			m_pfn_glCullFace;
	PFN_QGLDELETELISTS		m_pfn_glDeleteLists;
	PFN_QGLDISABLE			m_pfn_glDisable;
	PFN_QGLENABLE			m_pfn_glEnable;
	PFN_QGLEND				m_pfn_glEnd;
	PFN_QGLENDLIST			m_pfn_glEndList;
	PFN_QGLGENLISTS			m_pfn_glGenLists;
	PFN_QGLLISTBASE			m_pfn_glListBase;
	PFN_QGLLOADIDENTITY		m_pfn_glLoadIdentity;
	PFN_QGLMATRIXMODE		m_pfn_glMatrixMode;
	PFN_QGLNEWLIST			m_pfn_glNewList;
	PFN_QGLNORMAL3F			m_pfn_glNormal3f;
	PFN_QGLORTHO			m_pfn_glOrtho;
	PFN_QGLPOINTSIZE		m_pfn_glPointSize;
	PFN_QGLPOLYGONMODE		m_pfn_glPolygonMode;
	PFN_QGLPOPMATRIX		m_pfn_glPopMatrix;
	PFN_QGLPUSHMATRIX		m_pfn_glPushMatrix;
	PFN_QGLROTATED			m_pfn_glRotated;
	PFN_QGLROTATEF			m_pfn_glRotatef;
	PFN_QGLSCALEF			m_pfn_glScalef;
	PFN_QGLTEXCOORD2F		m_pfn_glTexCoord2f;
	PFN_QGLTEXENVF			m_pfn_glTexEnvf;
	PFN_QGLTEXGENF			m_pfn_glTexGenf;
	PFN_QGLTEXPARAMETERF	m_pfn_glTexParameterf;
	PFN_QGLTRANSLATED		m_pfn_glTranslated;
	PFN_QGLTRANSLATEF		m_pfn_glTranslatef;
	PFN_QGLVERTEX2F			m_pfn_glVertex2f;
	PFN_QGLVERTEX3F			m_pfn_glVertex3f;
	PFN_QGLVIEWPORT			m_pfn_glViewport;

	PFN_QE_CHECKOPENGLFORERRORS	m_pfn_QE_CheckOpenGLForErrors;
	PFN_QEW_SETUPPIXELFORMAT	m_pfn_QEW_SetupPixelFormat;
	PFN_QWGL_CREATECONTEXT		m_pfn_wglCreateContext;
	PFN_QWGL_DELETECONTEXT      m_pfn_wglDeleteContext;
	PFN_QWGL_MAKECURRENT		m_pfn_wglMakeCurrent;
	PFN_QWGL_SHARELISTS			m_pfn_wglShareLists;
	PFN_QWGL_SWAPBUFFERS		m_pfn_wglSwapBuffers;
	PFN_QWGL_USEFONTBITMAPS		m_pfn_wglUseFontBitmaps;

	PFN_QERAPP_GETQEGLOBALSHGLRC	m_pfnGetQeglobalsHGLRC;

	// glu stuff
	PFN_QGLUPERSPECTIVE			m_pfn_gluPerspective;
	PFN_QGLULOOKAT				m_pfn_gluLookAt;
