...
bool g_blockScreenUpdates = false;
...
const intptr_t g_msgBSPDone = RegisterWindowMessage("_BSPDone");
const intptr_t g_msgBSPStatus = RegisterWindowMessage("_BSPStatus");
