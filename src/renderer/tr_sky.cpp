...
static void DrawSkySide(struct image_s* image, const int mins[2], const int maxs[2]) {
	...
	glColor4f(tr.identityLight * 0.72f,
		tr.identityLight * 0.72f,
		tr.identityLight * 0.78f,
		1.0f);
...
static void DrawSkySideInner(struct image_s* image, const int mins[2], const int maxs[2]) {
	...
	glColor4f(tr.identityLight * 0.95f,
		tr.identityLight * 0.98f,
		tr.identityLight * 1.10f,
		0.55f);
